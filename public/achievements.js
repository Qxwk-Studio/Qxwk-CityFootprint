  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: '🚀', name: '飞天梦', desc: '到访过任一卫星发射中心（酒泉、太原、西昌、文昌）', done: hasAny(LAUNCH) },
      ],
    },
    {
      title: '📍 城市打卡',
      items: [
        ...
        { icon: '🌙', name: '黄鹤楼下', desc: '到访过 武汉（黄鹤楼）', done: citySet.has('武汉') },
        { icon: '🏯', name: '滕王高阁', desc: '到访过 南昌（滕王阁）', done: citySet.has('南昌') },
        { icon: '🌅', name: '岳阳楼记', desc: '到访过 岳阳（岳阳楼）', done: citySet.has('岳阳') },
        { icon: '🌉', name: '长江第一桥', desc: '到访过 武汉（长江大桥）', done: citySet.has('武汉') },
      ],
    },
    {
      title: '🧭 极限挑战',
      items: [
        ...
        { icon: '🏜️', name: '盆地之渊', desc: '到访过中国海拔最低点（艾丁湖 -154 米）所在地——吐鲁番', done: citySet.has('吐鲁番') },
        { icon: '🔥', name: '火洲炼狱', desc: '到访过中国最热的地方——吐鲁番（历史最高温 50℃+）', done: citySet.has('吐鲁番') },
        { icon: '❄️', name: '北境寒极', desc: '到访过中国最冷的地方——呼伦贝尔（历史最低温 -50℃ 以下）', done: citySet.has('呼伦贝尔') },
      ],
    },
  ];
}
